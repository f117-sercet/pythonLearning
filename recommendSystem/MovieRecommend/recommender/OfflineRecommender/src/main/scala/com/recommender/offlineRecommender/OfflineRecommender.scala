...
import spire.algebra.RingAlgebra.ZAlgebra
 ...
 *
 * @author: 段世超
 * @aate: Created in 2024/7/16 18:18
 */
case class Movie(
                  mid: Int,
                  name: String,
...
object OfflineRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    implicit val mongoConfig = MongoConfig(config("momgo.uri"),config("mongo.db"))
  ...
  //计算两个电影之间的余弦相似度
  private def consinSim(movie1: DoubleMatrix, movie2: DoubleMatrix) = {
